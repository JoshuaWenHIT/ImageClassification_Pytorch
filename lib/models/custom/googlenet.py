...
class Network(nn.Module):
    def __init__(self, config):
        ...
        self.b1 = nn.Sequential(
            nn.Conv2d(config.dataset.n_channels, 64, kernel_size=7, stride=2, padding=3),
            nn.ReLU(),
        ...
        self.fc = nn.Linear(1024, config.dataset.n_classes)

        self.b1.apply(init_weights)
        self.b2.apply(init_weights)
        self.b3.apply(init_weights)
        self.b4.apply(init_weights)
        self.b5.apply(init_weights)
